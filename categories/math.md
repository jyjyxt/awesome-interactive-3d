# Math Interactive Concepts

Interactive math visualizers for trigonometry, algebra, graphing, and systems
of equations.
...
- Interaction: drag the point or angle slider, toggle degrees/radians, snap to
  common angles.
- Exports: PNG, GIF, MP4.
...
- Interaction: drag `a`, `b`, and `c` to reshape the graph.
- Exports: PNG, GIF, MP4.
...
- Teaches: how initial value `a` and base `b` in `y = a*b^x` produce growth or
  decay.
- Interaction: drag the initial value and base to update the curve, y-intercept,
...
- Teaches: how two linear equations graph as lines and how their intersection
  gives the solution.
- Interaction: drag two lines to compare one solution, no solution, and
