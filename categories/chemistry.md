# Chemistry Interactive Concepts

Interactive chemistry visualizers for reaction mechanisms, atom conservation,
...
- Interaction: drag the reaction-progress slider, rotate the 3D view, zoom, and
  toggle labels.
- Exports: PNG, GIF, MP4.
...
- Interaction: drag the reaction slider to watch bonds break and reform.
- Exports: PNG, GIF, MP4.
...
- Teaches: how coefficients balance each element on both sides of a chemical
  equation.
- Interaction: adjust coefficients and watch live atom counts for
  `H2 + O2 -> H2O`.
- Exports: PNG, GIF, MP4.
